        ...
        <div class="sidebar px-4 py-4 py-md-4 me-0">
            <div class="d-flex flex-column h-100">
                ...
                @if($rolePermissions)
                        ...
                        @if($rolePermission->permission->url == 'dashboard')
                ...
                @endif
                 ...
                 @if($rolePermissions)
                        @foreach($rolePermissions as $rolePermission)
                        <li class="collapsed">
                            @if($rolePermission->permission->url == 'manage-product')
                            <a class="m-link {{ request()->is('admin/keyword_Request')  || request()->is('admin/keyword') ? 'active' : '' }}" data-bs-toggle="collapse" data-bs-target="#menu-product" href="#">
                                <i class="icofont-chart-flow fs-5"></i> <span>Manage Product</span> <span class="arrow icofont-rounded-down ms-auto text-end fs-5"></span>
                            </a>
                            @endif
                            <!-- Menu: Sub menu ul -->
                            <ul class="sub-menu collapse" id="menu-product">
                                    @if($rolePermission->permission->url == 'view-request-received')
                                    ...
                                    @if($rolePermission->permission->url == 'products')
                ...
                @endif
                    ...
                    @if($rolePermissions)
                        @foreach($rolePermissions as $rolePermission)
                         @if($rolePermission->permission->url == 'manage-sellers')
                    ...
                    @endif    
                     ...
                     @if($rolePermissions)
                        @foreach($rolePermissions as $rolePermission)
                         @if($rolePermission->permission->url == 'inquiries')
                        <li><a class="m-link {{ request()->is('admin/inqury') ? 'active' : '' }}" href="{{route('admin.inquiry')}}"><i class="icofont-notepad fs-5"></i> <span>Inquiries</span></a></li>
                          @endif
                         @if($rolePermission->permission->url == 'reports')
                        <li class="collapsed">
                            <a class="m-link {{ request()->is('admin/keywordrepoert')  || request()->is('admin/sellerrepoert') || request()->is('admin/buyerrepoert') || request()->is('admin/inquiryrepoert') ? 'active' : '' }}" data-bs-toggle="collapse" data-bs-target="#menu-repoerts" href="#">
                                <i class="icofont-law-document fs-5"></i> <span>Reports</span> <span class="arrow icofont-rounded-down ms-auto text-end fs-5"></span>
                            </a>
                            <ul class="sub-menu collapse" id="menu-repoerts">
                                <li><a class="ms-link {{ request()->is('admin/keywordrepoert') ? 'active' : '' }}" href="{{route('keywordrepoert')}}">Keywords</a></li>
                    ...
                    @if($rolePermissions)
                        @foreach($rolePermissions as $rolePermission)
                         @if($rolePermission->permission->url == 'user-role')
                    ...
                    @endif 
                        ...
                        <li><a class="m-link {{ request()->is('admin/userpermission') ? 'active' : '' }}" href="{{route('userpermission')}}"><i class="icofont-ui-user-group fs-5"></i> <span>User Permission</span></a></li>

                    @if($rolePermissions)
                        @foreach($rolePermissions as $rolePermission)
                       
                        <li class="collapsed">
                              @if($rolePermission->permission->url == 'buyer-inquiries')
                            <a class="m-link {{ request()->is('buyer/inquiry')  || request()->is('buyer/createinquiry') ? 'active' : '' }}" data-bs-toggle="collapse" data-bs-target="#menu-inquiries" href="#">
                                <i class="icofont-papers fs-5"></i> <span>My Inquiries</span> <span class="arrow icofont-rounded-down ms-auto text-end fs-5"></span>
                            </a>
                            @endif
                            <ul class="sub-menu collapse" id="menu-inquiries">
                                @if($rolePermission->permission->url == 'manage-inquiries')
                                <li><a class="ms-link {{ request()->is('buyer/inquiry') ? 'active' : '' }}" href="{{route('viewbuyerinquiry')}}">Manage Inquiries</a></li>
                                @endif
                                @if($rolePermission->permission->url == 'create-inquiries')
                    ...
                    @if($rolePermissions)
                        @foreach($rolePermissions as $rolePermission)
                        @if($rolePermission->permission->url == 'buyer-profile')
                    ...
                    @if($rolePermissions)
                        @foreach($rolePermissions as $rolePermission)
                        @if($rolePermission->permission->url == 'seller-bids')
                    ...
                    @if($rolePermissions)
                        @foreach($rolePermissions as $rolePermission)
                        @if($rolePermission->permission->url == 'seller-profile')
            ...
            function fetchData() {
                $.ajax({
                    ...
                    success: function(result) {
                        console.log(result.sellerquery);
