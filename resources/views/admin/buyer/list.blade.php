                            ...
                            <h3 class="fw-bold mb-0">Manage Buyers</h3>
                             @if($rolePermissions)
                                @foreach($rolePermissions as $rolePermission)
                                    @if($rolePermission->permission->url == 'create-buyer')
                                    ...
                                    <table id="myDataTable" class="table table-hover align-middle mb-0" style="width: 100%;">  
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                               ...
                                               <td>
                                                    @php $countDisplayed = false; @endphp
                                                    @foreach($sellerquery as $query)
                                                        @if($query->buyer_id == $buyers->id && !$countDisplayed)
                                                            {{$query->count()}}
                                                            @php $countDisplayed = true; @endphp
                                                        @endif
                                                    @endforeach
                                                </td>
                                ...
                                <div class="row g-3 mb-3">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control" id="dataScaleY" placeholder="Last Name" name="last_name" onkeypress='return ((event.charCode >= 65 && event.charCode <= 90) || (event.charCode >= 97 && event.charCode <= 122) || (event.charCode == 32))'required>
                                        </div>
                                ...
                                <div class="row g-3 mb-3">
                                   ...
                                   <div class="col-md-6" id="businessgst">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control" id="gst" placeholder="GSTIN" name="gst" size="15" maxlength="15" oninput="updatePattern()" onkeypress='return event.charCode >= 48 && event.charCode <= 57'>
                                        </div>
                                ...
                                <div class="row g-3 mb-3">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control" id="editmobile" placeholder="Mobile Number" name="mobile_number"
                                            required size="10" maxlength="10" minlength="10" onkeypress='return event.charCode >= 48 && event.charCode <= 57'>
                                ...
                                <div class="row g-3 mb-3">
                                   ...
                                   <div class="col-md-6" id="businessgstedit">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control" id="gstedit" placeholder="GSTIN" name="gst" size="15" maxlength="15" oninput="updatePatternedit()" onkeypress='return event.charCode >= 48 && event.charCode <= 57'>
                                        </div>
