                    ...
                    <div class="col-md-9 register-right">
                        ...
                        <div class="tab-content" id="myTabContent">
                            <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                                <h3 class="register-heading">Registed as Buyer</h3>
                                <div class="row register-form">
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group">
                                            <label>Is the Seller an Businees Entity?</label>
                                            <div class="maxl">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <input type="text" class="form-control" placeholder="GSTIN" value="" />
                                        </div>
                            ...
                            <div class="tab-pane fade show" id="profile" role="tabpanel" aria-labelledby="profile-tab">
                                <h3  class="register-heading">Registed as Seller</h3>
                                <div class="row register-form">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <input type="text" class="form-control" placeholder="First Name *" value="" />
...
<style type="text/css">
    .register {
     background:linear-gradient(to right, rgb(116 8 255) 0, rgb(168 37 233) 100%);
     margin-top: 3%;
     padding: 3%;
     overflow: hidden;
}
